...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_Fuzzer
{
	...
	public partial class Test_Fuzzer
	{
		...
		/********************************************************************/
		[TestMethod]
		public void Test_Fuzzer_Play_Xm_Bad_Instrument()
		{
			...
			Compare_Playback(Path.Combine(dataDirectory, "F"), "Play_Xm_Bad_Instrument.xm", sequence, 4000, Xmp_Format.Default, Xmp_Interp.Nearest);
		}
	}
}
