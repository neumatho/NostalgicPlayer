...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_Mixer
{
	...
	public partial class Test_Mixer
	{
		...
		/********************************************************************/
		[TestMethod]
		public void Test_Mixer_Stereo_16Bit_Spline()
		{
			using (StreamReader sr = new StreamReader(OpenStream(dataDirectory, "Mixer_16Bit_Spline.data")))
			{
				...
				for (c_int i = 0; i < 5; i++)
					New_Event(opaque, 0, i, 0, 20 + i * 20, 2, 0, 0x0f, 2, 0, 0);
