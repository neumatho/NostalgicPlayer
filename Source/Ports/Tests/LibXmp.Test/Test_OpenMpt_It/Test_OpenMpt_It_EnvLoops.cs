...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_OpenMpt_It
{
	...
	public partial class Test_OpenMpt_It
	{
		...
		/// Impulse Tracker (and Fasttracker 2), envelope position is
		...
		/********************************************************************/
		[TestMethod]
		public void Test_OpenMpt_It_EnvLoops()
		{
			Compare_Mixer_Data(Path.Combine(dataDirectory, "OpenMpt", "It"), "EnvLoops.it", "EnvLoops.data");
		}
	}
}
