...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_Porta
{
	...
	public partial class Test_Porta
	{
		...
		public void Test_Porta_Invalid_Ins_Ft2()
		{
			...
			New_Event(opaque, 0, 2, 0, Key_D4, Ins_Inval, 0, Effects.Fx_TonePorta, 4, 0, 0);
			New_Event(opaque, 0, 3, 0, 0, Ins_Inval, 0, 0x00, 0, 0, 0);	// FT2 only
			...
			// Row 2: Invalid instrument with tone portamento (FT2)
			//
			...
			// Row 3: Invalid instrument without note keeps playing (FT2)
			//
