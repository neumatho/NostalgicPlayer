...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_Player
{
	...
	public partial class Test_Player
	{
		...
		/// for instruments with envelopes and active sustain. Pattern 0
		/// tests delayed keyoff with and without an instrument number;
		/// pattern 1 tests release reset; pattern 2 tests fadeout reset.
		///
		...
		///        does not release sustain.
		/// 28-2F: Delay with no note/instrument resets the envelope
		///        positions.
		///
		/// 00-03: Delay with no note/no ins# is equivalent to delay with
		///        note. Both reset envelope positions and reset release and
		///        retrigger.
		/// 04-07: Delay with keyoff/no ins# resets envelopes/release without
		///        retriggering the sample. There's no alternate
		...
		///        with a note and an ins#. Both reset envelopes/release
		///        and retrigger.
		/// 0C-0F: Delay with keyoff and an ins# resets envelopes/release
		...
		///        Fasttracker 2 or ft2-clone
		///        (Minor: ft2-clone ramps the volume envelope here.)
		/// 08-0B: Delay with no note and an ins# is equivalent to delay with
		///        a note and an ins#. Both reset fadeout and retrigger the
		///        sample.
		...
		/********************************************************************/
		[TestMethod]
		public void Test_Player_Ft2_Delay_Envelope_Sustain()
		{
			Compare_Mixer_Data(dataDirectory, "Ft2_Delay_Envelope_Sustain.xm", "Ft2_Delay_Envelope_Sustain.data");
		}
	}
}
