...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_Player
{
	...
	public partial class Test_Player
	{
		/********************************************************************/
		/// <summary>
		/// When the current playing instrument does not have a volume
		/// envelope, keyoff cuts the volume to 0 (in addition to starting
		/// fadeout, as usual). The playing note (or a new note) can be
		/// restored by setting the volume again. In this example, fadeout
		/// is NOT reset, and the channel continues to fade out.
		///
