...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_Player
{
	...
	public partial class Test_Player
	{
		...
		/********************************************************************/
		[TestMethod]
		public void Test_Player_It_Portamento_Envelope_Reset()
		{
			Compare_Mixer_Data(dataDirectory, "It_Portamento_Envelope_Reset.it", "It_Portamento_Envelope_Reset.data");
		}
	}
}
