...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_Effect
{
	...
	public partial class Test_Effect
	{
		...
		/********************************************************************/
		[TestMethod]
		public void Test_Effect_Set_Nna_Cont()
		{
			...
			New_Event(opaque, 0, 0, 0, 60, 1, 44, 0x0f, 2, Effects.Fx_It_InstFunc, 0x04);
			...
			Assert.AreEqual(43, vi.Vol / 16, "Not fading out");
			...
			Assert.AreEqual(59, vi.Note, "Not same note");
			Assert.AreEqual(0, vi.Ins, "Not same instrument");
			Assert.AreEqual(43, vi.Vol / 16, "Not continuing");
