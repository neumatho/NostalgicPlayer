...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_Module_Length
{
	...
	public partial class Test_Module_Length
	{
		...
		/********************************************************************/
		[TestMethod]
		public void Test_Module_Length_Ode2Ptk()
		{
			Ports.LibXmp.LibXmp opaque = Ports.LibXmp.LibXmp.Xmp_Create_Context();
			c_int time = 0;

			c_int ret = LoadModule(Path.Combine(dataDirectory, "P"), "Ode2Ptk.mod", opaque);
			...
			Assert.AreEqual(18, mi.Mod.Len, "Module length");
			Assert.AreEqual(85472, fi.Total_Time, "Estimated time");
