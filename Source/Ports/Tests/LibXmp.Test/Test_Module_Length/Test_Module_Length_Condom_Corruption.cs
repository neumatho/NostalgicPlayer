...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_Module_Length
{
	...
	public partial class Test_Module_Length
	{
		...
		/********************************************************************/
		[TestMethod]
		public void Test_Module_Length_Condom_Corruption()
		{
			Ports.LibXmp.LibXmp opaque = Ports.LibXmp.LibXmp.Xmp_Create_Context();
			c_int time = 0;

			c_int ret = LoadModule(Path.Combine(dataDirectory, "P"), "Condom_Corruption.mod", opaque);
			...
			Assert.AreEqual(45, mi.Mod.Len, "Module length");
			Assert.AreEqual(207358, fi.Total_Time, "Estimated time");
			...
			Assert.IsLessThan(15, time / 1000 - fi.Total_Time, "Elapsed time");
