...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_Next_Order
{
	/// <summary>
	/// 
	/// </summary>
	public partial class Test_Next_Order
	{
		/********************************************************************/
		/// <summary>
		/// 
		...
		/********************************************************************/
		[TestMethod]
		public void Test_Next_Order_Skip()
		{
			...
			opaque.Xmp_Next_Position();
			opaque.Xmp_Play_Frame();
			Assert.AreEqual(2, p.Ord, "Incorrect pattern");
