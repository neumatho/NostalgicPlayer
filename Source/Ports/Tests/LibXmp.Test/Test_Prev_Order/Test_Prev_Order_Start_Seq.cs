...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_Prev_Order
{
	...
	public partial class Test_Prev_Order
	{
		...
		/********************************************************************/
		[TestMethod]
		public void Test_Prev_Order_Start_Seq()
		{
			...
			Assert.AreEqual(4, p.Ord, "Didn't start at pattern 4");
			Assert.AreEqual(1, p.Sequence, "Wrong sequence");
			...
			opaque.Xmp_Play_Frame();
			Assert.AreEqual(4, p.Ord, "Incorrect pattern");
