...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_No_Note
{
	...
	public partial class Test_No_Note
	{
		...
		/********************************************************************/
		[TestMethod]
		public void Test_No_Note_Same_Ins_Ft2()
		{
			...
			New_Event(opaque, 0, 6, 0, Key_C5, Ins_0, 0, 0x00, 0, 0, 0);
			New_Event(opaque, 0, 7, 0, 0, 0, 0, Effects.Fx_VolSet, Set_Vol, Effects.Fx_SetPan, Set_Pan);
			New_Event(opaque, 0, 8, 0, Constants.Xmp_Key_Off, Ins_0, 0, 0x00, 0, 0, 0);
			...
			Check_New(xc, vi, Key_C5, Ins_0, Ins_0_Sub_0_Vol, Ins_0_Sub_0_Pan, Ins_0_Fade, "row 6");
			...
			Check_On(xc, vi, Key_C5, Ins_0, Set_Vol, Set_Pan, Ins_0_Fade, "row 7");
			...
			Check_On(xc, vi, Key_C5, Ins_0, -1, Ins_0_Sub_0_Pan, Ins_0_Fade, "row 8");

			Assert.AreEqual(65536 - Ins_0_Fade, xc.FadeOut, "didn't start fade out");
			Assert.AreEqual(346, vi.Vol, "didn't fade out");

			opaque.Xmp_Play_Frame();

			Assert.AreEqual(341, vi.Vol, "didn't fade out");
