...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_New_Note
{
	...
	public partial class Test_New_Note
	{
		...
		/********************************************************************/
		[TestMethod]
		public void Test_New_Note_No_Ins_Ft2()
		{
			...
			New_Event(opaque, 0, 1, 0, 50, 0, 0, 0x00, 0, 0, 0);
			...
			// Row 1: No instrument with new note (FT2)
			//
			// When no instrument and a new note is set, FT2 plays
			// the new note with old sample and current volume
			opaque.Xmp_Play_Frame();

			Assert.AreEqual(0, vi.Ins, "Not old instrument");
			Assert.AreEqual(49, vi.Note, "Not new note");
			Assert.AreEqual(43 * 16, vi.Vol, "Not current volume");
