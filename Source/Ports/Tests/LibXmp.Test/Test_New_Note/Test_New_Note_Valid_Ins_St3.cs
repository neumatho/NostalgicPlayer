...
namespace Polycode.NostalgicPlayer.Ports.Tests.LibXmp.Test.Test_New_Note
{
	...
	public partial class Test_New_Note
	{
		...
		/********************************************************************/
		[TestMethod]
		public void Test_New_Note_Valid_Ins_St3()
		{
			...
			New_Event(opaque, 0, 2, 0, Key_D4, Ins_1, 0, 0x00, 0, 0, 0);
			...
			// Row 2: Valid instrument with new note (ST3)
			//
			// When a new valid instrument and a new note is set, ST3 plays
