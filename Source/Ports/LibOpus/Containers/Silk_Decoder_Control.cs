...
namespace Polycode.NostalgicPlayer.Ports.LibOpus.Containers
{
	...
	internal class Silk_Decoder_Control
	{
		...
		public readonly Pointer<opus_int32> Gains_Q16 = new Pointer<opus_int32>(Constants.Max_Nb_Subfr);
		...
		public readonly Pointer<opus_int16> LTPCoef_Q14 = new Pointer<opus_int16>(Constants.Ltp_Order * Constants.Max_Nb_Subfr);
