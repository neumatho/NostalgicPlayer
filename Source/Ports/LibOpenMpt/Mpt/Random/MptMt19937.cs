...
namespace Polycode.NostalgicPlayer.Ports.LibOpenMpt.Mpt.Random
{
	...
	/// </summary>
	internal class MptMt19937 : Mt19937, IEngine_Seed_Traits, IEngine_Traits<uint32_t>
	{
		/********************************************************************/
		/// <summary>
		/// Constructor
		/// </summary>
		/********************************************************************/
		private MptMt19937(Seed_Seq seed) : base(seed)
		{
		}
		...
		/// </summary>
		/********************************************************************/
		public static size_t Seed_Bits => (size_t)(Marshal.SizeOf(result_type) * 8 * new Mt19937().state_size);
		...
		/// </summary>
		/********************************************************************/
		public c_int Result_Bits => word_size;
	}
}
