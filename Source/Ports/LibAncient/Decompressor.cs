...
using System.IO;
using Polycode.NostalgicPlayer.Ports.LibAncient.Internal;

namespace Polycode.NostalgicPlayer.Ports.LibAncient
{
	/// <summary>
	...
	public class Decompressor : IDisposable
	{
		...
		/// </summary>
		/********************************************************************/
		public Decompressor(Stream crunchedDataStream, bool exactSizeKnown)
		{
			impl = new DecompressorImpl(crunchedDataStream, exactSizeKnown);
		}
