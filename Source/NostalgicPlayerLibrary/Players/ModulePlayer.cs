			...
			try
			{
				...
				lock (currentPlayer)
				{
					...
					if (initOk)
					{
						...
						StaticModuleInformation = new ModuleInfoStatic(loader.PlayerAgentInfo, loader.ConverterAgentInfo, currentPlayer.ModuleName.Trim(), FindAuthor(), currentPlayer.Comment, loader.ModuleFormat, loader.PlayerName, currentPlayer.ModuleChannelCount, loader.CrunchedSize, loader.ModuleSize, currentPlayer.SupportFlags, currentPlayer.SubSongs.Number, currentPlayer.Instruments, currentPlayer.Samples);
