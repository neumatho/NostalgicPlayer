...
namespace Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages
{
	...
	/// </summary>
	public partial class AgentsListUserControl : UserControl, IDependencyInjectionControl
	{
		/// <summary>
		...
		private bool? cachedEnableCheckColumn = null;
		...
		/// </summary>
		/********************************************************************/
		public void InitializeControl(IMainWindowApi mainWindowApi, IAgentManager agentManager, IModuleHandlerService moduleHandlerService, ISettingsService settingsService)
		{
		...
		{
			get => IsHandleCreated ? agentsDataGridView.Columns[0].Visible : cachedEnableCheckColumn ?? true;

			set => SetEnableCheckColumn(value);
		}
		...
		/********************************************************************/
		/// <summary>
		/// Apply cached property values when the handle is created
		/// </summary>
		/********************************************************************/
		...
		/// set it directly, otherwise cache it
		/// </summary>
		/********************************************************************/
		private void SetEnableCheckColumn(bool value)
		{
			if (IsHandleCreated)
			{
				agentsDataGridView.Columns[0].Visible = value;
				cachedEnableCheckColumn = null;
			}
			else
				cachedEnableCheckColumn = value;
		}
