...
namespace Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages
{
	partial class AgentsPageControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.formatsListControl = new Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentLists.FormatsListUserControl();
			this.navigatorPlayersPage = new Krypton.Navigator.KryptonPage();
			this.playersListControl = new Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentLists.PlayersListUserControl();
			this.navigatorOutputPage = new Krypton.Navigator.KryptonPage();
			this.outputListControl = new Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentLists.OutputListUserControl();
			this.navigatorSampleConvertersPage = new Krypton.Navigator.KryptonPage();
			this.sampleConvertersListControl = new Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentLists.SampleConvertersListUserControl();
			this.navigatorVisualsPage = new Krypton.Navigator.KryptonPage();
			this.visualsListControl = new Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentLists.VisualsListUserControl();
			this.navigatorDecrunchersPage = new Krypton.Navigator.KryptonPage();
			this.decrunchersListUserControl = new Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentLists.DecrunchersListUserControl();
		...
		private Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentLists.PlayersListUserControl playersListControl;
		private Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentLists.OutputListUserControl outputListControl;
		...
		private Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentLists.SampleConvertersListUserControl sampleConvertersListControl;
		private Krypton.Navigator.KryptonPage navigatorVisualsPage;
		private Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentLists.VisualsListUserControl visualsListControl;
		private Krypton.Navigator.KryptonPage navigatorFormatsPage;
		private Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentLists.FormatsListUserControl formatsListControl;
