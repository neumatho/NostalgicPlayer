...
namespace Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages
{
	...
	/// </summary>
	public partial class MixerPageControl : UserControl, IDependencyInjectionControl, ISettingsPage
	{
		...
		private KryptonCheckBox[] channelCheckBoxes;
		...
		/// </summary>
		/********************************************************************/
		public void InitializeControl(IMainWindowApi mainWindowApi, IAgentManager agentManager, IModuleHandlerService moduleHandlerService, IMixerConfigurationFactory mixerConfigurationFactory, SoundSettings soundSettings)
		{
