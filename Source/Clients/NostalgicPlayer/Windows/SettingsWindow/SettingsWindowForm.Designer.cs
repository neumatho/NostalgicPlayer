...
namespace Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow
{
	partial class SettingsWindowForm
	{
		...
		private void InitializeComponent()
		{
			...
			optionsPageControl = new Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.OptionsPageControl();
			navigatorModulesPage = new Krypton.Navigator.KryptonPage();
			modulesPageControl = new Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.ModulesPageControl();
			navigatorPathsPage = new Krypton.Navigator.KryptonPage();
			pathsPageControl = new Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.PathsPageControl();
			navigatorMixerPage = new Krypton.Navigator.KryptonPage();
			mixerPageControl = new Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.MixerPageControl();
			navigatorAgentsPage = new Krypton.Navigator.KryptonPage();
			agentsPageControl = new Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.SettingsWindow.Pages.AgentsPageControl();
