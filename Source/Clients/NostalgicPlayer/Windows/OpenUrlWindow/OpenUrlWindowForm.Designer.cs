namespace Polycode.NostalgicPlayer.Client.GuiPlayer.Windows.OpenUrlWindow
{
	partial class OpenUrlWindowForm
	{
		...
		private void InitializeComponent()
		{
			...
			cancelButton = new Polycode.NostalgicPlayer.Controls.Buttons.NostalgicButton();
			playButton = new Polycode.NostalgicPlayer.Controls.Buttons.NostalgicButton();
			addButton = new Polycode.NostalgicPlayer.Controls.Buttons.NostalgicButton();
			urlLabel = new Polycode.NostalgicPlayer.Controls.Texts.NostalgicLabel();
			nameTextBox = new Polycode.NostalgicPlayer.Controls.Inputs.NostalgicTextBox();
			urlTextBox = new Polycode.NostalgicPlayer.Controls.Inputs.NostalgicTextBox();
			...
			nameLabel.Text = "Enter the name to be shown in the module list";
			// 
			// cancelButton
			// 
			...
			urlLabel.TabIndex = 2;
			urlLabel.Text = "Enter an URL to the stream you want to listen to";
			// 
			// nameTextBox
			// 
			...
			nameTextBox.Size = new System.Drawing.Size(342, 21);
			...
			urlTextBox.Size = new System.Drawing.Size(342, 21);
		...
		private NostalgicPlayer.Controls.Texts.NostalgicLabel nameLabel;
		private NostalgicPlayer.Controls.Inputs.NostalgicTextBox nameTextBox;
		private NostalgicPlayer.Controls.Buttons.NostalgicButton cancelButton;
		private NostalgicPlayer.Controls.Buttons.NostalgicButton playButton;
		private NostalgicPlayer.Controls.Buttons.NostalgicButton addButton;
		private NostalgicPlayer.Controls.Inputs.NostalgicTextBox urlTextBox;
		private NostalgicPlayer.Controls.Texts.NostalgicLabel urlLabel;
	}
}