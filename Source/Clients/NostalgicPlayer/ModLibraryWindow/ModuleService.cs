...
namespace Polycode.NostalgicPlayer.Client.GuiPlayer.ModLibraryWindow
{
    ...
    internal class ModuleService
    {
        ...
        /// </summary>
        /********************************************************************/
        public void AddOfflineFile(string nameWithPath, long size) => offlineFiles.Add(new ModEntry(nameWithPath, size));
        ...
        /// </summary>
        /********************************************************************/
        public void AddOnlineFile(string nameWithPath, long size) => onlineFiles.Add(new ModEntry(nameWithPath, size));
        ...
        /// </summary>
        /********************************************************************/
        public void ClearOfflineFiles() => offlineFiles.Clear();
        ...
        /// </summary>
        /********************************************************************/
        public void ClearOnlineFiles() => onlineFiles.Clear();
    }
}