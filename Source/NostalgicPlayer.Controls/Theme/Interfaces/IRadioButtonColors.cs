...
{
	/// <summary>
	/// Holds all colors used by a themed radio button
	/// </summary>
	public interface IRadioButtonColors
	{
		/// <summary></summary>
