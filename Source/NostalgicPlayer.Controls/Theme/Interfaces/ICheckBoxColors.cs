...
{
	/// <summary>
	/// Holds all colors used by a themed check box
	/// </summary>
	public interface ICheckBoxColors
	{
		/// <summary></summary>
		...
		/// <summary></summary>
		Color NormalCheckMarkColor { get; }
		/// <summary></summary>
		...
		/// <summary></summary>
		Color PressedCheckMarkColor { get; }
		/// <summary></summary>
		...
		/// <summary></summary>
		Color FocusedCheckMarkColor { get; }
		/// <summary></summary>
		...
		/// <summary></summary>
		Color DisabledCheckMarkColor { get; }
		/// <summary></summary>
