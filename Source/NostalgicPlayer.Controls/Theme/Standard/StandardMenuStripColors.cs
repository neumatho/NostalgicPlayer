...
{
	/// <summary>
	/// Different colors used by menu strips
	/// </summary>
	internal class StandardMenuStripColors : IMenuStripColors
	{
		private static readonly Color normalMenuBarItemTextColor = Color.FromArgb(30, 57, 91);

		private static readonly Color hoverMenuBarItemBorderColor = Color.FromArgb(167, 171, 176);
		private static readonly Color hoverMenuBarItemBackgroundStartColor = Color.FromArgb(255, 225, 112);
		private static readonly Color hoverMenuBarItemBackgroundStopColor = Color.FromArgb(255, 255, 255);
		private static readonly Color hoverMenuBarItemTextColor = Color.FromArgb(30, 57, 91);

		private static readonly Color openMenuBarItemBorderColor = Color.FromArgb(167, 171, 176);
		private static readonly Color openMenuBarItemBackgroundStartColor = Color.FromArgb(255, 255, 255);
		private static readonly Color openMenuBarItemBackgroundStopColor = Color.FromArgb(255, 255, 255);
		private static readonly Color openMenuBarItemTextColor = Color.FromArgb(30, 57, 91);

		private readonly IFormColors formColors = new StandardFormColors();
		private readonly IMenuColors menuColors = new StandardMenuColors();
