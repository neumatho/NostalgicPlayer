...
{
	/// <summary>
	/// Different colors used by radio buttons
	/// </summary>
	internal class StandardRadioButtonColors : IRadioButtonColors
	{
		...
		private static readonly Color normalDotColor = Color.FromArgb(30, 57, 91);
		...
		private static readonly Color hoverDotColor = Color.FromArgb(30, 57, 91);
		...
		private static readonly Color pressedDotColor = Color.FromArgb(30, 57, 91);
		...
		private static readonly Color focusedDotColor = Color.FromArgb(30, 57, 91);
