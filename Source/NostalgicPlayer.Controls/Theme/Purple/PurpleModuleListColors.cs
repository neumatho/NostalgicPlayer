...
namespace Polycode.NostalgicPlayer.Controls.Theme.Purple
{
	...
	/// </summary>
	internal class PurpleModuleListColors : IModuleListColors
	{
		...
		private static readonly Color normalSubSongColor = Color.FromArgb(255, 81, 155);
		private static readonly Color selectedSubSongColor = Color.FromArgb(255, 81, 155);
