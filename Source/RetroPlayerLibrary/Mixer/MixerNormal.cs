...
using Polycode.RetroPlayer.RetroPlayerLibrary.Mixer.Containers;
		...
		static MixerNormal()
		{
			...
			try
			{
				...
				if (Environment.Is64BitProcess)
					dllPtr = LoadLibrary(@"RetroPlayerLibrary_Native-x64.dll");
				else
					dllPtr = LoadLibrary(@"RetroPlayerLibrary_Native-x86.dll");
			}
			finally
			{
