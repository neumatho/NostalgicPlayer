...
namespace Polycode.NostalgicPlayer.Kit.C
{
	...
	/// </summary>
	public struct CPointer<T> : IPointerInternal, IIterator<CPointer<T>, T>, IBidirectional_Iterator<CPointer<T>, T>, IRandom_Access_Iterator<CPointer<T>, T>, IEquatable<CPointer<T>>, IComparable<CPointer<T>>, IClearable, IDeepCloneable<CPointer<T>>
	{
		...
		/********************************************************************/
		/// <summary>
		/// Returns a copy of the pointer moved one element towards the
		/// beginning of the range (C++ --it)
		/// </summary>
		/********************************************************************/
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		CPointer<T> IBidirectional_Iterator<CPointer<T>>.Prev()
		{
			return this - 1;
		}
