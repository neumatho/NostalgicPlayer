...
{
	/// <summary>
	/// MOS8580 filter emulation
	/// </summary>
	internal sealed class Filter8580 : Filter
	{
		...
		///
		/// curvePosition 0 .. 1, where 0 sets center frequency high ("light")
		/// and 1 sets it low ("dark"), default is 0.5
		/// </summary>
		/********************************************************************/
