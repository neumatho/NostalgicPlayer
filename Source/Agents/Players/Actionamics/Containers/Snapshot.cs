...
namespace Polycode.NostalgicPlayer.Agent.Player.Actionamics.Containers
{
	...
	internal class Snapshot : ISnapshot
	{
		...
		/// </summary>
		/********************************************************************/
		public Snapshot(GlobalPlayingInfo playingInfo, VoiceInfo[] voices, SampleExtra[] sampleExtras)
		{
			PlayingInfo = playingInfo.MakeDeepClone();
			Voices = ArrayHelper.CloneObjectArray(voices);
			SampleExtras = ArrayHelper.CloneObjectArray(sampleExtras);
		}
		...
		/// </summary>
		/********************************************************************/
		public SampleExtra[] SampleExtras
		{
			get;
		}
	}
