...
namespace Polycode.NostalgicPlayer.Agent.Player.Tfmx
{
	...
	internal static class TfmxIdentifier
	{
		...
		[
			...
			// Grand Monster Slam
			0xb54457fc, 0x97707404,

			// Circus Attractions
			0x5f04d9af, 0x72ef7307,
			...
			// X-out
			0x9264f036, 0x22a86efb, 0x711d8520, 0x2f525ee0, 0x8412d8d5, 0xc0376a19, 0xade39424, 0x2adbf5f9, 0x236d305d, 0x14adce8c
		];
