...
namespace Polycode.NostalgicPlayer.Agent.SampleConverter.Iff8Svx
{
	...
	/// </summary>
	internal abstract class Iff8SvxLoaderWorkerBase : Iff8SvxWorkerBase, ISampleLoaderAgent
	{
		...
		public bool GetInformationString(int line, out string description, out string value)
		{
			...
			switch (line)
			{
				...
				case 0:
				{
					description = Resources.IDS_IFF8SVX_INFODESCLINE0;
				...
				case 1:
				{
					description = Resources.IDS_IFF8SVX_INFODESCLINE1;
					value = string.IsNullOrEmpty(copyright) ? Resources.IDS_IFF8SVX_NA : copyright;
					break;
				}
				...
				case 2:
				{
					description = Resources.IDS_IFF8SVX_INFODESCLINE2;
					value = string.IsNullOrEmpty(annotation) ? Resources.IDS_IFF8SVX_NA : annotation;
					break;
				}
		...
		public bool LoadHeader(ModuleStream moduleStream, out LoadSampleFormatInfo formatInfo, out string errorMessage)
		{
			...
			if (!gotVhdr)
			{
				errorMessage = Resources.IDS_IFF8SVX_ERR_NOVHDR;
				return false;
			}

			if (!gotBody)
			{
				errorMessage = Resources.IDS_IFF8SVX_ERR_NOBODY;
				return false;
			}
