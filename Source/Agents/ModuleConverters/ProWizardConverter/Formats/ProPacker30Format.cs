...
namespace Polycode.NostalgicPlayer.Agent.ModuleConverter.ProWizardConverter.Formats
{
	...
	/// ProPacker 3.0
	/// </summary>
	internal class ProPacker30Format : ProPackerNewFormatBase
	{
		...
		/// </summary>
		/********************************************************************/
		public override string OriginalFormat => Resources.IDS_PROWIZ_NAME_AGENT30;
		#endregion
		...
		{
			return CheckForProPackerFormat(moduleStream) == 30;
		}
