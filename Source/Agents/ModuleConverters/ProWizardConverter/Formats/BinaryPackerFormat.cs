...
namespace Polycode.NostalgicPlayer.Agent.ModuleConverter.ProWizardConverter.Formats
{
	...
	/// Binary Packer
	/// </summary>
	internal class BinaryPackerFormat : ProWizardForPcBase
	{
		...
		/// </summary>
		/********************************************************************/
		public override string OriginalFormat => Resources.IDS_PROWIZ_NAME_AGENT50;
		#endregion
		...
		protected override bool CheckModule(ModuleStream moduleStream)
		{
			...
			if (moduleStream.Read_B_UINT32() != 0x424e5221)		// BNR!
				return false;
		...
		protected override IEnumerable<byte[]> GetPatterns(ModuleStream moduleStream)
		{
			...
			for (int i = 0; i < numberOfPatterns; i++)
			{
				...
				for (int j = 0; j < 64 * 4; j++)
				{
					...
					// Effect
					pattern[j * 4 + 2] = (byte)((byt1 >> 2) & 0x0f);

					// Sample number
					pattern[j * 4 + 2] |= (byte)((byt4 << 1) & 0xf0);
					pattern[j * 4] = (byte)((byt4 >> 3) & 0xf0);
