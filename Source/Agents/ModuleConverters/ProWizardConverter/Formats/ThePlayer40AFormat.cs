...
namespace Polycode.NostalgicPlayer.Agent.ModuleConverter.ProWizardConverter.Formats
{
	...
	/// The Player 4.0A
	/// </summary>
	internal class ThePlayer40AFormat : ThePlayer4xFormatBase
	{
		...
		/// </summary>
		/********************************************************************/
		public override string OriginalFormat => Resources.IDS_PROWIZ_NAME_AGENT36;
		#endregion
		...
		{
			return CheckForThePlayerFormat(moduleStream, 0x50343041);		// P40A
		}
		#endregion
