...
namespace Polycode.NostalgicPlayer.Agent.ModuleConverter.ProWizardConverter.Formats
{
	...
	/// Perfect Song Packer 
	/// </summary>
	internal class PerfectSong2Format : PerfectSongFormatBase
	{
		...
		/// </summary>
		/********************************************************************/
		public override string OriginalFormat => Resources.IDS_PROWIZ_NAME_AGENT63;
		#endregion
		...
		protected override bool CheckModule(ModuleStream moduleStream)
		{
			...
			if (moduleStream.Read_B_UINT64() != 0x50455246534e4732)		// PERFSNG2
				return false;

			uint temp = moduleStream.Read_B_UINT32() + 12 + 12;
			if ((temp > moduleStream.Length) || (temp < 802))
				return false;

			moduleStream.Seek(temp - 4, SeekOrigin.Begin);
