...
namespace Polycode.NostalgicPlayer.Agent.ModuleConverter.ProWizardConverter.Formats
{
	...
	/// The Player 2.2A
	/// </summary>
	internal class ThePlayer22AFormat : ThePlayer2x_3xFormatBase
	{
		...
		/// </summary>
		/********************************************************************/
		public override string OriginalFormat => Resources.IDS_PROWIZ_NAME_AGENT66;
		#endregion
		...
		{
			return CheckForThePlayerFormat(moduleStream, 0x50323241);		// P22A
		}
		#endregion
		...
		{
			return (byte)(c3 > 0x7f ? (0x100 - c3) << 4 : c3);
		}
		#endregion
	}
}
